...
* [Integración por fracciones parciales](#integración-por-fracciones-parciales)
    ...
    * [Caso 2: $Q(x)$ es producto de factores lineales, algunos de los cuales se repiten.](#caso-2:-$q(x)$-es-producto-de-factores-lineales,-algunos-de-los-cuales-se-repiten.)

    * [Caso 3: $Q(x)$ contiene factores cuadráticos irreducibles, de los cuales ninguno se repite.](#caso-3:-$q(x)$-contiene-factores-cuadráticos-irreducibles,-de-los-cuales-ninguno-se-repite.)

    * [Caso 4: $Q(x)$ contiene factores cuadráticos irreducibles repetidos.](#caso-4:-$q(x)$-contiene-factores-cuadráticos-irreducibles-repetidos.)
